...
int main(){
    ...
    string little[] = {"yuta","eita","chloe","waka","supawat","kaya","eiki","brady","ken","sophie","kotori","tsubasa","tomoki","sky","mimika","sakura","christopher","saya","riho","alyssa","hana","malia","derek","seira","kazuto","andrew","joelle","symphony","julian","joshua","lola","riki"}; // littles name comes here
    string big[] = {"eiki","alex","jojo","noelle","miori","ryo","noe","jordan","chikako","elena","ellie","misora","yuuki"}; // bigs name comes here
    int num_matches[] = {1,2,3,3,2,3,3,10,3,3,2,2,10}; // how many littles each big wants comes here

    int num_big = 13, num_little = 32;
    ...
    cout << "Total loop iterations: " << loop_count << endl;
