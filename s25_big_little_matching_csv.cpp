...
int main(){
    ...
    string little[] = {"kate","takahito","ella","sarah","parker","nana","kyla","mahoko","chasen","kamahiwa","madoka","simon","josh","michelle","daisy","gabby","joeun","jenny","sam"}; // littles name comes here
    string big[] = {"sam","noelle","niki","miori","afiq","hugo","elena","anna","tomoki","theo","alexander"}; // bigs name comes here
    int num_matches[] = {2,10,1,1,10,10,2,2,1,1,2}; // how many littles each big wants comes here

    int num_big = 11, num_little = 19;
    ...
    ofstream outfile("big_little_matches_s25.csv");
    outfile << "Big,Little\n";
