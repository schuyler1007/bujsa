...
int main(){
    ...
    string little[] = {"michelle","yudai","taizo","angelina","koya","ellie","ibuki","misora","prathika","rio","alexander","carly","yuto"}; // littles name comes here
    string big[] = {"yuuki","emika","lili","jordan","airi"}; // bigs name comes here
    int num_matches[] = {2,2,3,3,4}; // how many littles each big wants comes here

    int num_big = 5, num_little = 13;
